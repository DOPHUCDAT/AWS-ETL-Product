...
def get_item(num, ti):
    base_url = f"https://www.amazon.com/s?k=elden+ring&crid=KS5QRMFGXDJD&sprefix=elden+ring+%2Caps%2C319&ref=nb_sb_noss_2"
    items = []
    ...
    while len(items) < num:
        ...
        if response.status_code == 200:  
            ...
            item_containers = soup.find_all("div",{"class": "s-result-item"})
